  ...
  return (
    <div>
        <div className="title-panel-container">
            ...
            content={
                <div className="panel-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat quod incidunt facere optio! Exercitationem libero eos corporis at. Est fuga exercitationem debitis itaque alias adipisci eos repudiandae temporibus quos animi!</div>
            }  
            bottom={false}  
            // change this
            />
        ...
        <div className="contact-list">
            <Panel 
                ...
                content={<div className="contact-info" >isaac.bergl@outlook.com</div>}
                horizontal={true}
                bottom={false}
            />
            <Panel 
